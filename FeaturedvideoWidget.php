...
class FeaturedvideoWidget extends Widget
{
    ...
    public static function set_small_video_width($v)
    {
        self::$small_video_width;
    }

    protected static $small_video_height = 150;
    public static function set_small_video_height($v)
    {
        self::$small_video_height;
    }

    public static $title = "Featured Video";

    public static $cmsTitle = "Featured Video";

    public static $description = "Display one video from Youtube, Google Video or Vimeo. Full sized videos can also be viewed";
